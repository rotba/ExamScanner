...
public class ResolveAnswersANdResolveConflictsTest extends StateFullTest {
    ...
    public void setUp() {
        ...
        dbCallback = db ->{
            ...
            db.getVersionDao().insert(new com.example.examscanner.persistence.local.entities.Version(dinaBarzilayVersionNumber, examId, null, false, true));
            db.getVersionDao().insert(new com.example.examscanner.persistence.local.entities.Version(theDevilVersionNumber, examId, null, false, true));
        };
        super.setUp();
