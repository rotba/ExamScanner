...
public class HomeFragmentTest extends StateFullTest {
    ...
    public void setUp() {
        dbCallback = db -> {
            comp = "COMP";
            db.getExamDao().insert(new Exam(comp, 0,"2020","THE_EMPTY_URL",0,0, null,QAD_NUM_OF_QUESTIONS, null));
            caspl = "CASPL";
            db.getExamDao().insert(new Exam(caspl, 1,"2020","THE_EMPTY_URL",0,0, null,QAD_NUM_OF_QUESTIONS, null));
        };
        super.setUp();
    }
