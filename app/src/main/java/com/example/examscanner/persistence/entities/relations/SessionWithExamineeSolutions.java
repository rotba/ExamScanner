...
public class SessionWithExamineeSolutions {
    @Embedded
    private Session session;
    @Relation(parentColumn = Session.pkName, entityColumn =ExamineeSolution.fkSession )
    private List<ExamineeSolution> examineeSolutions;

    public SessionWithExamineeSolutions(Session session, List<ExamineeSolution> examineeSolutions) {
